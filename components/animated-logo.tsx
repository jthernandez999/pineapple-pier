...
export default function AnimatedLogo() {
   ...
   const notScrolledClasses =
      'left-1/2 -top-[13.25rem] -translate-x-1/2 translate-y-[15rem] scale-[2] 2xl:scale-[3] 2xl:translate-y-[15rem] xl:translate-y-[15rem] xl:scale-[2] lg:translate-y-[15rem] lg:scale-[1.5] md:translate-y-[15rem] md:scale-[1.25]';
   ...
   const scrolledMobile = 'left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 md:-translate-y-1/2';
   const scrolledDesktop =
      'md:hidden lg:hidden xl:block xl:left-[4rem] xl:ml-4 xl:-translate-x-0 xl:top-1/2 xl:-translate-y-1/2  scale-[1.3]  xl:-translate-x-[12rem] xl:scale-[.5] xl:pl-0 2xl:scale-[.5] 2xl:-translate-x-[10.5rem] 2xl:ml-0 2xl:pl-0';
