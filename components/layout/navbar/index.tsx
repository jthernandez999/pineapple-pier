   ...
   return (
      <li className="group relative">
         ...
         {hasSubmenu && (
            ...
            <div className="pointer-events-none fixed left-0 z-[65] min-h-[25vh] w-full translate-y-4 transform bg-white opacity-0 transition-all delay-700 duration-1200 group-hover:pointer-events-auto group-hover:translate-y-16 group-hover:opacity-100 2xl:top-[2.2rem]">
